    ...
    <html>
      ...
      <body>
        ...
        <ul>
          <li>
            <b>Program: </b>
            <xsl:value-of select="studentPortfolio/student/course/program"/>
          </li>
          <li>
            <b>Major: </b>
            <xsl:value-of select="studentPortfolio/student/course/major"/>
          </li>
          <li>
            <b>Year: </b>
            <xsl:value-of select="studentPortfolio/student/course/year"/>
          </li>
          <li>
            <b>Section: </b>
            <xsl:value-of select="studentPortfolio/student/course/section"/>
          </li>
        </ul>
        <h3>Achievements</h3>
        <ul>
